<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/mPaciente.Master"
    CodeBehind="PacienteEdit2.aspx.cs" Inherits="DalSic.Paciente.PacienteEdit2" ValidateRequest="false"
    Theme="Login" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    Text="Validar Padron Provincial" />
            ...
            <uc1:PacienteProvincial runat="server" id="PacienteProvincial" Visible="False" />
             <br />
                <br />
             <asp:Button ID="btnCopiarTodo" runat="server" 
    Text="Copiar Todo" Visible="False" onclick="btnCopiarTodo_Click" />  <br />
               <asp:Button ID="btnCopiarDatosPrincipales" runat="server" 
    Text="Copiar Datos Principales" Visible="False" onclick="btnCopiarDatosPrincipales_Click" /><asp:Button ID="btnCopiarDomicilio" runat="server" onclick="btnCopiarDomicilio_Click" 
    Text="Copiar Domicilio" Visible="False" /><asp:Button ID="btnCopiarMadre" runat="server" onclick="btnCopiarMadre_Click" 
    Text="Copiar Datos Madre" Visible="False" /><asp:Button ID="btnCopiarPadre" runat="server" onclick="btnCopiarPadre_Click" 
    Text="Copiar Datos Padre" Visible="False" />
