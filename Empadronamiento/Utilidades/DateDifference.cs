...
namespace Empadronamiento.Utilidades
{
    [Serializable]
    public class DateDifference
    {
        ...
        public override string ToString()
        {
            ...
            string annos = this.year == 0 ? "" : this.year.ToString() + " año(s) ";
            string meses = this.month == 0 ? "" : this.month.ToString() + " mes(es) ";
            string dias = this.day == 0 ? "" : this.day.ToString() + " día(s) ";
        ...
        public int Weeks
        {
            get
            {
                return toDate.Subtract(fromDate).Days / 7;
            }
        }
